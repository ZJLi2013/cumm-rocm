"""V4: LUT-based gather implicit GEMM kernel.

Replaces V3's serial pair scan with O(1) inp_row_lut lookup per thread.
"""
import math
import os
...
def implicit_gemm_v4_forward(
    ...
    return _forward_common(
        ...
        version_tag='v4',
        compiled_kernels=_V4_COMPILED_KERNELS,
        compile_fn=_compile_implicit_gemm_v4,
    )
