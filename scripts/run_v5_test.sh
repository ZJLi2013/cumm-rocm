...
echo "=== Step 1: V5 correctness ==="
python -m pytest test/test_implicit_gemm.py::TestImplicitGemmV5 -v --tb=long

echo "=== Step 2: V4 regression ==="
python -m pytest test/test_implicit_gemm.py::TestImplicitGemmV4::test_basic_f32 -v --tb=short

echo "=== Step 3: Benchmark (V4 vs V5 only, skip V3) ==="
python test/bench_v5_only.py
