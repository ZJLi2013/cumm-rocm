...
echo "=== Step 1: V7 correctness ==="
python -m pytest test/test_implicit_gemm.py::TestImplicitGemmV7 -v --tb=long

echo "=== Step 2: V4 regression ==="
python -m pytest test/test_implicit_gemm.py::TestImplicitGemmV4::test_basic_f32 -v --tb=short

echo "=== Step 3: Benchmark (V4 vs V6 vs V7) ==="
python test/bench_v7.py
