...
echo "=== Step 4: mfma_f32_16x16x4f32_n2_ashared_kpipe correctness ==="
python -m pytest test/test_implicit_gemm.py::TestImplicitGemmMfmaF32_16x16x4N2ASharedKPipe -v --tb=long

echo "=== Step 5: mfma_f32_32x32x2f32 correctness ==="
python -m pytest test/test_implicit_gemm.py::TestImplicitGemmMfmaF32_32x32x2 -v --tb=long

echo "=== Step 6: scalar_tile regression ==="
python -m pytest test/test_implicit_gemm.py::TestImplicitGemmScalarTile::test_basic_f32 -v --tb=short

echo "=== Step 7: Benchmark current kernel family ==="
