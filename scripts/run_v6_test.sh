...
echo "=== Step 1: V6 correctness ==="
python -m pytest test/test_implicit_gemm.py::TestImplicitGemmV6 -v --tb=long

echo "=== Step 2: V4 regression ==="
python -m pytest test/test_implicit_gemm.py::TestImplicitGemmV4::test_basic_f32 -v --tb=short

echo "=== Step 3: Benchmark (V4 vs V6) ==="
python test/bench_v6.py
